...
#
# usage: ./increase_picture.py dirname
#
...
def increase(img_src, save_dir):
    ...
    img_name = '.'.join(img_src.split('.')[:-1])
    img_src = save_dir + "/" + img_src
    trans_img = []
    ...
    for i, img in enumerate(trans_img):
        ...
        cv2.imwrite(save_dir + "/" + img_name + "_" + str(i) + "trans.jpg" ,img) 
